...
export const metadata: Metadata = {
  ...
  description: "AI agents that handle inbound calls, SMS, email, and lead recovery for real estate, brokerages, property management, short-term rentals, and investors.",
