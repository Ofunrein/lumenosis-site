...
export function CalendarCTA() {
  ...
  return (
    <section id="book" className="border-b border-[var(--color-line)] bg-white py-16 md:py-24">
      <div className="mx-auto grid w-[min(1200px,calc(100%-32px))] items-start gap-10 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="grid gap-5">
          {formId ? (
            ...
            <div className="rounded-[var(--radius)] border border-[var(--color-line)] bg-[var(--color-bg-cream)] p-6 text-[var(--color-muted)]">
