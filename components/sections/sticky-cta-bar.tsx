...
export function StickyCtaBar() {
  ...
  return (
    <aside
      ...
      aria-hidden={!show}
      className={`fixed inset-x-3 bottom-3 z-40 mx-auto flex max-w-3xl items-center justify-between gap-3 rounded-2xl border border-[var(--color-line)] bg-[var(--color-bg-cream)]/95 backdrop-blur-md px-4 py-3 shadow-md transition-all md:inset-x-0 md:bottom-5 ${
