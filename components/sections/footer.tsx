...
export function Footer() {
  return (
    <footer className="bg-black py-12 text-sm text-white/50 md:py-16 border-t border-[var(--color-line)]">
      <div className="mx-auto flex w-[min(1200px,calc(100%-32px))] flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <nav aria-label="Footer" className="flex flex-wrap gap-5">
          <Link
            href="/privacy"
            className="transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-purple)] focus-visible:ring-offset-2"
          >
            Privacy
          </Link>
          <Link
