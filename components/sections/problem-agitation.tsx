      ...
      <div className="mx-auto w-[min(1200px,calc(100%-32px))]">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {leaks.map((leak) => (
            <article
              key={leak.n}
              className="rounded-[var(--radius)] border border-[var(--color-line)] bg-white p-6 shadow-[0_4px_24px_rgba(17,21,19,0.10)]"
            >
              <div className="mb-3 grid size-9 place-items-center rounded-lg bg-[var(--color-brand-violet-soft)] text-sm font-bold text-[var(--color-brand-violet)]">
                {leak.n}
              </div>
