      ...
      <div className="mx-auto grid w-[min(1200px,calc(100%-32px))] gap-10 md:grid-cols-[0.6fr_1fr]">
        ...
        <Accordion type="single" collapsible className="w-full">
          {faq.map((item, i) => (
            ...
            >
              <AccordionTrigger className="text-left font-[family-name:var(--font-display)] text-lg font-semibold text-white hover:no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-purple)] focus-visible:ring-offset-2">
                {item.q}
              </AccordionTrigger>
