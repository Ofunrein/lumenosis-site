            ...
            <button
              ...
              className={`rounded-[var(--radius-pill)] border px-4 py-2 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-purple)] focus-visible:ring-offset-2 ${
                activeCategory === "all"
                  ...
                  : "border-[var(--color-line)] bg-white/55 text-[var(--color-muted)] hover:border-[var(--color-brand-purple)] hover:text-[var(--color-ink-charcoal)] dark:bg-black/35 dark:text-white/85 dark:hover:text-white"
              }`}
            >
              All Results
            </button>
          ...
          {visibleStudies.map((study) => {
            ...
            return (
              <article
                ...
                className="mb-4 break-inside-avoid rounded-[var(--radius)] border border-[var(--color-line)] bg-white/78 p-5 shadow-[var(--shadow-soft)] backdrop-blur-sm transition-transform hover:-translate-y-1 dark:bg-black/70"
              >
