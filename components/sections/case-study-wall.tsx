          ...
          {visibleStudies.map((study) => {
            ...
            return (
              <GlowCard
                ...
                glowColor="purple"
                customSize
                className="mb-4 break-inside-avoid overflow-hidden rounded-[var(--radius)] p-5 shadow-[var(--shadow-soft)] transition-transform hover:-translate-y-1 [--backdrop:#ffffff] [--backup-border:var(--color-line)] [--outer:0] [--size:115] dark:[--backdrop:#14101c]"
              >
