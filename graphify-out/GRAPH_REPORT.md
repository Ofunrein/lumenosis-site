# Graph Report - lumenosis-site  (2026-09-10)

## Corpus Check
- 139 files · ~1,345,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 799 nodes · 1143 edges · 72 communities (53 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2960be7e`
...
- `POST()` --calls--> `platformApiConfigured()`  [INFERRED]
  app/api/platform/demos/[id]/approve/route.ts → lib/platform-auth.ts
- `POST()` --calls--> `verifyPlatformRequest()`  [INFERRED]
  app/api/platform/demos/[id]/approve/route.ts → lib/platform-auth.ts
...
Cohesion: 0.06
Nodes (61): POST(), POST(), POST(), NO_STORE, DemoRoom, demoRooms, Demo, DemoAdminPage() (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.18
Nodes (10): siteStructuredData, AuroraBackground(), D, ScrollExperience(), metadata, AriaDeepDive(), FinalCTA(), Footer() (+2 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (42): POST(), DemoRoomExperience(), EmailResult, money(), VoiceConfig, GET(), NO_STORE, unauthorized() (+34 more)

### Community 3 - "Community 3"
Cohesion: 0.20
Nodes (10): StarButton(), StarButtonProps, cn(), Badge(), BadgeProps, badgeVariants, GlowingEffectCard(), GlowingEffectCardProps (+2 more)
...
Cohesion: 0.06
Nodes (34): AtIcon(), BathIcon(), BedIcon(), DoorIcon(), IconProps, LensIcon(), LetterIcon(), PinIcon() (+26 more)
...
Cohesion: 0.09
Nodes (21): devDependencies, @biomejs/biome, @playwright/test, tailwindcss, @tailwindcss/postcss, tw-animate-css, @types/node, @types/pg (+13 more)
...
Cohesion: 0.15
Nodes (13): reLogos, repeatedLogos, TrustStrip(), Carousel, CarouselApi, CarouselContent, CarouselContext, CarouselContextProps (+5 more)
...
Cohesion: 0.21
Nodes (8): ThemeToggle(), prefersReducedMotion(), runThemeTransition(), ThemeTransitionOptions, ViewTransitionDocument, Topbar(), MenuToggleIcon(), MenuToggleProps
...
Cohesion: 0.14
Nodes (9): Reveal(), RevealProps, RevealVariant, caseStudies, CaseStudy, timeline, TimelineWeek, CaseStudyCard (+1 more)
...
Cohesion: 0.43
Nodes (5): RotatingText(), Hero(), RESPONSE_STEPS, useCountUp(), useResponseCycle()
...
Cohesion: 0.33
Nodes (3): PricingTier, StarButton(), StarButtonProps
...
- **Why does `ThemeToggle()` connect `Community 15` to `Community 2`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 34`, `Community 67`, `Community 70`, `Community 71`, `Community 41`, `Community 12`, `Community 15`, `Community 26`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `DemoRoom` connect `Community 0` to `Community 2`, `Community 13`?**
